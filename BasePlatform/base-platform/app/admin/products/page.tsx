          ...
          <table className="min-w-full divide-y divide-gray-200 border border-gray-200">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {products.map((product, key) => (
                <tr key={key}>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 w-full max-w-[30%]">{product.name}</td> 
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 w-full max-w-[50%]">{product.description}</td> 
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 w-full">{product.price.amount / 100} EUR</td>
